...
model = model_from_json(open(r"E:\fruits_classification\model\model2\model2.json", "r").read())
model.load_weights(r"E:\fruits_classification\model\model2\best_weights.h5")
...
while cap.isOpened():
    ...
    cv2.putText(test_img,f"{predicted_gesture}", (int(x+100), int(y)), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
