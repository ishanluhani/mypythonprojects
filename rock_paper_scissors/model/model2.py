...
filepath="weight_checkpoints/weights-improvement-{epoch:02d}-{val_accuracy:.2f}.hdf5"
...
with open("model1/model2.json","w") as json_file:
    json_file.write(model_json)
print('model saved')
model.save_weights("model1/best_weights.h5")